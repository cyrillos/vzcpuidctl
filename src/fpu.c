...
static short xsave_cpuid_features[] = {
	X86_FEATURE_FPU,	/* 0 -> CPUID_1_EDX */
	X86_FEATURE_XMM,	/* 0 -> CPUID_1_EDX */
	X86_FEATURE_AVX,	/* 4 -> CPUID_1_ECX */
	X86_FEATURE_MPX,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_MPX,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_AVX512F,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_AVX512F,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_AVX512F,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_INTEL_PT,	/* 9 -> CPUID_7_0_EBX */
	X86_FEATURE_PKU,	/* 11 -> CPUID_7_0_ECX */
	X86_FEATURE_HDC,	/* 14 -> CPUID_6_EAX */
};
